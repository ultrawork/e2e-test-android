...
/**
 * E2E API contract tests for Android v31 — Retrofit and ViewModel verification.
 *
...
class NotesApiContractTests {
    ...
    fun sc004_postNoteReturns201WithId() {
        ...
        val noteJson = gson.toJson(mapOf(
            "title" to "Test Note v31",
            "content" to "Test content for E2E v31 verification"
        ))
        ...
        assertEquals("Test Note v31", json.get("title").asString)
        assertEquals("Test content for E2E v31 verification", json.get("content").asString)
    }
    ...
    fun sc006_deleteExistingNoteReturns204() {
        ...
        val noteJson = gson.toJson(mapOf(
            "title" to "Note to delete v31",
            "content" to "This note will be deleted in E2E v31 test"
        ))
