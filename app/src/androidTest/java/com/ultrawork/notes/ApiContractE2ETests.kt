...
/**
 * E2E API contract tests for Android v29 — Retrofit and ViewModel verification.
 *
...
class ApiContractE2ETests {
    ...
    fun sc004_postNoteReturns201WithId() {
        ...
        val noteJson = gson.toJson(mapOf(
            "title" to "Test Note v29",
            "content" to "Test content for E2E v29 verification"
        ))
        ...
        assertEquals("Test Note v29", json.get("title").asString)
        assertEquals("Test content for E2E v29 verification", json.get("content").asString)
    }
    ...
    fun sc006_deleteExistingNoteReturns204() {
        ...
        val noteJson = gson.toJson(mapOf(
            "title" to "Note to delete v29",
            "content" to "This note will be deleted in E2E v29 test"
        ))
